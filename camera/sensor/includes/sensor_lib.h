...
/* 
 * Our a6010's kernel have 6 members in msm_camera_i2c_reg_setting,
 * but proprietary ov13850 sensor library is compiled with msm_camera_i2c_reg_setting,
 * that have 5 members and cause segfault when dumping.
 * Workaround this.
 */
struct msm_camera_i2c_reg_setting_5 {
...
struct sensor_lib_reg_settings_array {
  struct msm_camera_i2c_reg_setting_5 *reg_settings;
  uint32_t                          size;
};
...
typedef struct {
  ...
  int32_t (*sensor_fill_exposure_array)(uint16_t, uint32_t, uint32_t,
    int32_t, uint32_t, struct msm_camera_i2c_reg_setting_5 *);
...
struct msm_sensor_id_info_t_a6010 {
       uint16_t sensor_id_reg_addr;
       uint16_t sensor_id;
};

struct msm_camera_sensor_slave_info_a6010 {
       char sensor_name[32];
       char eeprom_name[32];
       ...
       enum msm_camera_i2c_reg_addr_type addr_type;
       struct msm_sensor_id_info_t_a6010 sensor_id_info;
...
typedef struct {
  /* sensor slave info */
  struct msm_camera_sensor_slave_info_a6010 *sensor_slave_info;
  ...
  /* start settings */
  struct msm_camera_i2c_reg_setting_5 *start_settings;

  /* stop settings */
  struct msm_camera_i2c_reg_setting_5 *stop_settings;

  /* group on settings */
  struct msm_camera_i2c_reg_setting_5 *groupon_settings;

  /* group off settings */
  struct msm_camera_i2c_reg_setting_5 *groupoff_settings;
