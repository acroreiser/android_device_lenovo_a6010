...
Return<void> RadioConfigResponse::getSimSlotsStatusResponse(
    const RadioResponseInfo& /* info */, const hidl_vec<V1_0::SimSlotStatus>& /* slotStatus */) {
    // TODO implement
    return Void();
}
...
Return<void> RadioConfigResponse::getPhoneCapabilityResponse(const RadioResponseInfo& /* info */, const V1_1::PhoneCapability& /* phoneCapability */) {
    // TODO implement
    return Void();
}
...
Return<void> RadioConfigResponse::getModemsConfigResponse(const RadioResponseInfo& /* info */, const V1_1::ModemsConfig& /* modemsConfig */) {
    // TODO implement
    return Void();
}
